  ...
  return Scaffold(
    ...
    Card(color: Colors.yellow,shadowColor:Colors.black87,
      ...
      trailing: Icon(Icons.call),
        ...
        Card(color: Colors.green,shadowColor: Colors.red,
          child: ListTile(
            leading: CircleAvatar(backgroundImage: AssetImage("assets/icons/Iconarchive-Incognito-Animal-2-Wolf.512.png"),),
            title: Text("siraj"),
            subtitle: Text("7994698813"),
    ...
    Card(color: Colors.purple,shadowColor: Colors.black87,
      child: ListTile(
      leading: CircleAvatar(backgroundImage: AssetImage("assets/icons/Iconarchive-Incognito-Animal-2-Wolf.512.png"),),
      title: Text("amal"),
      subtitle: Text("7994698813"),
      trailing: Icon(Icons.call),
        ...
        Card(color: Colors.pink,shadowColor: Colors.deepPurpleAccent,
          child: ListTile(
            leading: CircleAvatar(backgroundImage: AssetImage("assets/icons/Iconarchive-Incognito-Animal-2-Wolf.512.png"),),
            title: Text("jubair"),
            subtitle: Text("7994698813"),
